...
namespace Start_a_Town_.AI.Behaviors
{
    class TaskBehaviorEating : BehaviorPerformTask
    {
        ...
        protected override IEnumerable<Behavior> GetSteps()
        {
            ...
            var task = this.Task;
            //bool inInventory() { return actor.InventoryContains(this.Food.Object); }
            yield return BehaviorHelper.InteractInInventoryOrWorld(FoodInd, () => new InteractionHaul(task.GetAmount(FoodInd))); //));// 
            //yield return new BehaviorCustom() { InitAction = () => task.SetTarget(FoodInd, actor.Carried) };
            //yield return BehaviorHelper.SetTarget(FoodInd, () => actor.Carried);
            ...
            yield return eat;// new BehaviorInteractionNew(FoodInd, new Components.ConsumableComponent.InteractionConsume());
