...
namespace Start_a_Town_.Blocks
{
    ...
    {
        static readonly float AnimationSpeed = Engine.TicksPerSecond / 2f;//10f;
        ...
        public override void Draw(Vector3 blockcoords, Camera camera, Vector4 screenBounds, Color sunlight, Vector4 blocklight, Color fog, Color tint, float depth, Cell cell)
        {
            ...
            camera.WaterSpriteBatch.DrawBlock(Block.Atlas.Texture, screenBounds, this.Assets[cell.BlockData][cell.Variation], camera.Zoom, fog, tint, Color.White, sunlight, blocklight, Color.Red.ToVector4(), depth, this, blockcoords);
        ...
        public override MyVertex[] Draw(Canvas canvas, Chunk chunk, Vector3 blockcoords, Camera camera, Vector4 screenBounds, Color sunlight, Vector4 blocklight, Color fog, Color tint, float depth, int variation, int orientation, byte data)
        {
            ...
            //return canvas.Opaque.DrawBlock(Block.Atlas.Texture, screenBounds, this.Assets[data][0], camera.Zoom, fog, tint, Color.White, sunlight, blocklight, Color.Red.ToVector4(), depth, this, blockcoords);
    ...
    {
        static List<LiduidFlowProcess> FlowProcesses = new List<LiduidFlowProcess>();
        static readonly float FlowSpeed = Engine.TicksPerSecond / 2f;//10f;
        static float FlowT = FlowSpeed;
