...
namespace Start_a_Town_
{
    public abstract class BlockEntityWorkstation : BlockEntity
    {
        ...
        public override IEnumerable<IntVec3> InteractionSpots => BlockDefOf.Workbench.GetOperatingPositions(this.Map.GetCell(this.OriginGlobal).Orientation).Select(c=>this.OriginGlobal + c);
    }
    //public abstract class BlockEntityWorkstation : BlockEntity
    //{
    //    /// <summary>
