...
{
    class HaulComponentNew : EntityComponent
    {
        ...
        {
            //this.Animation = Graphics.Animation.Hauling;
            //this.Animation = Graphics.Animation.Hauling(parent);
            this.Animation = new Animation(AnimationDef.Haul);
        ...
        public override void Draw(MySpriteBatch sb, GameObject parent, Camera camera)
        {
            ...
            body.DrawGhost(this.Slot.Object, sb, finalpos, skyColor, blockColor, Color.White, fog, 0, camera.Zoom, (int)camera.Rotation, sprfx, 1f, depth);
