...
namespace Start_a_Town_.Components.Interactions
{
    class Carry : Interaction
    {
        ...
        {
            GameObjectSlot objSlot = target.Object.IsSpawned ? target.Object.ToSlotLink() : (from slot in actor.GetChildren() where slot.HasValue select slot).FirstOrDefault(foo => foo.Object == target.Object);// PersonalInventoryComponent.GetFirstOrDefault(parent, foo => foo == obj);
