...
{
    class MultiTile2Component : EntityComponent
    {
       ...
       // static public MultiTile2Component Create(GameObject parent, Sprite fullSprite, Dictionary<Vector3, Sprite> sprites)
        ...
        public override void ChunkLoaded(IObjectProvider net, GameObject parent)
        {
            DeployParts(net, parent);
        }
        ...
        private void DeployParts(IObjectProvider net, GameObject parent)
        {
      ...
      //          Game1.Instance.Effect.Parameters["Alpha"].SetValue(1);
        ...
        {
            if (Master.IsNull())
                sb.Draw(Sprite.Texture, camera.GetScreenBounds(parent.Global, Sprite.SourceRects[0][0]), Sprite.SourceRects[0][0], new Color(255, 255, 255, 127), 0, Sprite.OriginGround, SpriteEffects.None, 0);
            else
        ...
        {
            Controller.Instance.MouseoverBlockNext.Object = Master ?? parent;
