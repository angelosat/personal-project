...
namespace Start_a_Town_.Components
{
    ...
    public class Stat : ITooltippable
    {
        ...
        protected Stat(Types id, string name, BonusType type = BonusType.Flat, string description = "", int defaultValue = 0)
        {
            ID = id;
            Name = name;
            this.Type = type;
        ...
        static public Stat Create(Stat.Types type, int value)
        {
        ...
        {
            return new Label(this.ToString(this.Value));
        }
