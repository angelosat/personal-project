...
namespace Start_a_Town_.GameModes.Sandbox.Packets.Player
{
    public partial class PlayerPacketHandler : IPacketHandler
    {
        ...
        {
            this.PacketHandlers.Add(PacketType.PlayerStartMoving, new StartMoving());
            this.PacketHandlers.Add(PacketType.PlayerStopMoving, new StopMoving());
            this.PacketHandlers.Add(PacketType.PlayerJump, new Jump());
        }
