...
namespace Start_a_Town_
{
    public class MouseMap
    {
       ...
       //         Rectangle[] var = rect[i];
        ...
        public bool HitTestEarly(float x, float y)
        {
            Color[][][] map = Map;
            Color c = map[0][0][(int)(y * Texture.Width + x)];
            return c.A > 0;
        }
    ...
    public class Sprite : IDisposable
    {
        ...
        static public void Initialize()
        {
            ...
            BlockHighlight = new Sprite("blocks/highlightfull", Map.BlockDepthMap) { OriginGround = Block.OriginCenter };
        ...
        { return new Rectangle(-(int)OriginGround.X, -(int)OriginGround.Y, this.AtlasToken.Rectangle.Width + 2 * Graphics.Borders.Thickness, this.AtlasToken.Rectangle.Height + 2 * Graphics.Borders.Thickness); }
