...
{
    public class ListBoxObservableNew<TObject> : GroupBox, IListSearchable<TObject>
      where TObject : class, IListable
    {
        ...
        public ListBoxObservableNew(ObservableCollection<TObject> objects)
        {
            this.Bind(objects);
        }
        ...
        ListBoxObservableNew<TObject> Clear()
        {
            this.Controls.Clear();
            return this;
        }
        
        ListBoxObservableNew<TObject> Bind(ObservableCollection<TObject> collection)
        {
      ...
      where TObject : class
    {
        ...
        public ListBoxObservable(Func<TObject, Control> controlFactory)
        {
            this.ControlFactory = controlFactory;
        }
        public ListBoxObservable<TObject> Bind(ObservableCollection<TObject> collection)
        {
            if (collection == this.List)
                return this;
            if (this.List != null)
