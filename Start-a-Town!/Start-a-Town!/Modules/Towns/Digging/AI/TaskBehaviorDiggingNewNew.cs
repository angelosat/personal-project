...
namespace Start_a_Town_
{
    class TaskBehaviorDiggingNewNew : BehaviorPerformTask
    {
        ...
        protected override IEnumerable<Behavior> GetSteps()
        {
            ...
            yield return new BehaviorInteractionNew(MineInd, () => new InteractionMineDig());// this.Actor.Map.GetBlockMaterial(this.Task.GetTarget(0).Global).Type.SkillToExtract.GetInteraction());
