...
namespace Start_a_Town_
{
        public class CustomerTavern : CustomerProperties
        {
            ...
            //public Actor ServedBy, OrderTakenBy;
            //public bool IsServed => this.ServedBy != null;
            //public bool IsOrderTaken => this.OrderTakenBy != null;
            public int DishID = -1;
            ...
            //public CustomerTavern(Tavern tavern, int actorID, IntVec3 bed) : this(tavern)
            //{
            //    CustomerID = actorID;
            //    this.Bed = bed;
            //}
