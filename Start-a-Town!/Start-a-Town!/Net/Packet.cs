...
namespace Start_a_Town_.Net
{
    ...
    {
        PlayerConnecting = 1, PlayerDisconnected, PlayerEnterWorld, PlayerInputOld, AssignCharacter, RequestConnection,
        Chat, MapData,
        WorldInfo, Chunk,
        InstantiateObject, DisposeObject, ObjectEvent, SyncEntity,
        Ack,
        ServerBroadcast,
