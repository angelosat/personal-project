...
namespace Start_a_Town_
{
    static class ItemContent
    {
        ...
        static public readonly Sprite BagsGrayscale = new Sprite("soilbagbw", Map.BlockDepthMap) { OriginY = 8, OriginGround = new Vector2(16, 24), Joint = new Vector2(16, 24) };
        static public readonly Sprite BarsGrayscale = new Sprite("metalbars", Map.BlockDepthMap) { OriginY = 8, OriginGround = new Vector2(16, 24), Joint = new Vector2(16, 24) };
        static public readonly Sprite OreGrayscale = new Sprite("boulder", Map.BlockDepthMap) { OriginY = 8, OriginGround = new Vector2(16, 24) };
