...
namespace Start_a_Town_.Blocks
{
    class WorkbenchInterface : GroupBox
    {
        ...
        public WorkbenchInterface(BlockWorkbench.Entity parent, Vector3 workstationGlobal)
        {
            ...
            //this.QueuedOrdersUI = new Window();
            //this.QueuedOrdersUI.Client.Controls.Add(new InterfaceWorkbenchOrders());
        ...
        private void Craft()
        {
            ...
            Net.Client.PlayerCraftRequest(new Components.Crafting.CraftOperation(this.SelectedReaction.ID, product.Requirements, this.WorkstationGlobal));
