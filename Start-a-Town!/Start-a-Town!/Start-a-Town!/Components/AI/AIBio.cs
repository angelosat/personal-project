    ...
    class AIBio : Behavior
    {
        ...
        public AIBio()
        {
            Children = new List<Behavior>() { 
                //new AICondition(personality => personality.Needs["Hunger"].Value<50),
                new AICondition(agent => agent["Needs"].GetProperty<NeedCollection>("Needs")["Hunger"].Value<50),
           //     new AIFindNeed(20, "Hunger"),
                //new AIFindItem(),
             //   new AIInteraction()
            };
        ...
        public override Behavior Initialize(Personality personality)
        {
            //personality.Needs["Hunger"] = new Need("Hunger", 100);
          //  personality.SetNeed("Hunger", 100);
            return this;
        }
