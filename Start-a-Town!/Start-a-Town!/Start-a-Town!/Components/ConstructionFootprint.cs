...
{
    class ConstructionFootprint : Component
    {
        ...
        static public bool MaterialsAvailable(IObjectProvider net, GameObject parent)
        {
            ...
            return comp.Items.Values.FirstOrDefault(req => req.Amount < req.Max) != null;
        }
        ...
        public virtual void Finish(IObjectProvider net, GameObject parent, GameObject actor)
        {
            ...
            net.Despawn(parent);
            net.DisposeObject(parent.Network.ID);
        ...
        public override void GetTooltip(GameObject parent, UI.Control tooltip)
        {
            ...
            this.Product.Object.GetInfo().GetTooltip(this.Product.Object, box);
        ...
        internal override List<SaveTag> Save()
        {
            ...
            save.Add(new SaveTag(SaveTag.Types.Int, "ProductID", (int)this.Product.Object.ID));
        ...
        {
            this.Product = GameObject.Create((GameObject.Types)(int)save["ProductID"].Value).ToSlot();
