...
{
    class ConstructionOldComponent : Component
    {
      ...
      //  Dictionary<GameObject.Types, int> Materials { get { return (Dictionary<GameObject.Types, int>)this["Materials"]; } set { this["Materials"] = value; } }
        ...
        public ConstructionOldComponent()
        {
        ...
        {
            ConstructionOldComponent craft = new ConstructionOldComponent();
        ...
        public override bool HandleMessage(GameObject parent, ObjectEventArgs e)//GameObject sender, Message.Types msg)
        {
            ...
            switch (e.Type)
            {
                ...
                case Message.Types.Construct:
                    ...
                    e.Network.Despawn(parent);
                    e.Network.DisposeObject(parent.Network.ID);
                ...
                case Message.Types.ManageEquipment:
                    ...
                    SpriteComponent.ChangeOrientation(Product.Object);
                    return true;
                default:
        ...
        public override void Query(GameObject parent, List<InteractionOld> list)//GameObjectEventArgs e)
        {
          //  List<Interaction> list = e.Parameters[0] as List<Interaction>;
            ...
            list.Add(new InteractionOld(new TimeSpan(0, 0, 0, 1), Message.Types.FinishConstruction, parent, "Finish construction", 
            ...
            if (Product != null)
                if (SpriteComponent.HasOrientation(Product.Object))
        ...
        public override bool Activate(GameObject sender, GameObject parent)
        {
            ...
            float value = GetProperty<float>(Stat.ValueOld.Name) - 1;
            Properties[Stat.ValueOld.Name] = value;
            if (value <= 0)
            {
        ...
        private void GetBlueprintTooltip(GameObject parent, UI.Control tooltip)
        {
            ...
            Label lbl_progress = new Label(new Vector2(pnl_pic.Right, lbl_bp.Bottom), (int)(100 - (float)this[Stat.ValueOld.Name] * 100 / 60f) + "% Complete");
        ...
        public override void DrawMouseover(SpriteBatch sb, Camera camera, GameObject parent)// DrawObjectArgs e)
        {
            ...
            else
            {
                ...
                {
                    SpriteComponent.DrawPreview(sb, camera, parent.Global.RoundXY(), Product.Object);
                    return;
                }
                SpriteComponent sprite;
                if (Product.Object.TryGetComponent<SpriteComponent>("Sprite", out sprite))
                    sprite.DrawPreview(sb, camera, parent.Global.RoundXY(), (int)Product.Object["Sprite"]["Orientation"]);
            }
        }
        ...
        {
            Dictionary<string, SaveTag> byName = compTag.Value as Dictionary<string, SaveTag>;//.ToDictionary();
