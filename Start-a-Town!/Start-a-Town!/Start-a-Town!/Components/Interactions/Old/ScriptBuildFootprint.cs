...
{
    class ScriptBuildFootprint : Script
    {
        //public ScriptArgs Args { get; set; }
        public double Time { get; set; }
        public double Length { get; set; }
        public ScriptBuildFootprint()
        {
            this.ID = Script.Types.BuildFootprint;
            this.Name = "Building";
         ...
         //   this.SpeedBonus = Formula.GetFormula(Formula.Types.ConstructionSpeed);
            ...
            this.AddComponent(new ScriptEvaluations(this.Fail,
                ...
                //a => ConstructionFootprint.MaterialsAvailable(a.Net, a.Target.Object), Message.Types.InvalidTarget
                    )));
        ...
        {
            return new ScriptBuildFootprint();
        }
    }
}
