        ...
        public class Hoe
        {
            ...
            public class Factory
            {
                ...
                static GameObject Create(Material handleMaterial, Material headMaterial)
                {
                    ...
                    obj.AddComponent<GeneralComponent>().Initialize(ID, ObjectType.Equipment, "Hoe", "Used to dig soil and dirt.").Initialize(ItemSubType.Hoe);
                    ...
                    obj.AddComponent<SkillComponent>().Initialize(Skill.Argiculture);
                    ...
                    obj.AddComponent(new SpriteComponent(handle, new Sprite("hoe", 0) { Origin = new Vector2(16, 24) }));
