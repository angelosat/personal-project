        ...
        public class Stool
        {
            ...
            static public void Initialize()
            {
                ...
                var entitycrafting = new Reaction(
                    ...
                    Reaction.Reagent.Create(new Reaction.Reagent("Body", Reaction.Reagent.IsOfMaterialType(MaterialType.Wood), Reaction.Reagent.CanProduce(Reaction.Product.Types.Furniture))),
            ...
            public class Factory : IItemFactory
            {
                ...
                static GameObject Create()
                {
                    ...
                    obj.AddComponent<SpriteComponent>().Initialize(new Sprite("furniture/stool", Sprite.CubeDepth) { Origin = new Vector2(16, 24), Joint = new Vector2(16, 24) });
