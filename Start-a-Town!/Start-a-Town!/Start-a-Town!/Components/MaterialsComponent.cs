...
namespace Start_a_Town_.Components
{
    ...
    class MaterialsComponent : Component
    {
        ...
        public override void Read(System.IO.BinaryReader r)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                this.Parts.Add(name, new PartMaterialPair(name, Material.Templates[r.ReadInt32()]));
            }
        }
        ...
        internal override void Load(SaveTag save)
        {
            ...
            foreach(var item in list)
            {
                ...
                Material material = Material.Templates[item.GetValue<int>("Material")];
        ...
        static public bool IsFuel(GameObject item)
        {
            ...
            if (comp == null)
                return false;
            return comp.Parts.Values.Any(mat => mat.Material.Fuel > 0);
        }
    }    
}
