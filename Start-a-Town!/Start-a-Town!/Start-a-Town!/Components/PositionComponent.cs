    ...
    public class PositionComponent : Component
    {
      ...
      //      mov["Speed"] = this["Speed"];
        ...
        internal override List<SaveTag> Save()
        {
            ...
            // SAVE BY ID
            //data.Add(new Tag(Tag.Types.Float, Stat.X.ID.ToString(), global.X));
            //data.Add(new Tag(Tag.Types.Float, Stat.Y.ID.ToString(), global.Y));
            //data.Add(new Tag(Tag.Types.Float, Stat.Z.ID.ToString(), global.Z));
            //data.Add(new Tag(Tag.Types.Float, Stat.SpeedX.ID.ToString(), speed.X));
            //data.Add(new Tag(Tag.Types.Float, Stat.SpeedY.ID.ToString(), speed.Y));
            //data.Add(new Tag(Tag.Types.Float, Stat.SpeedZ.ID.ToString(), speed.Z));
            return data;
        }
        ...
        internal override void Load(SaveTag data)
        {
            ...
            //this["Speed"] = new Vector3((float)data["SpeedX"].Value, (float)data["SpeedY"].Value, (float)data["SpeedZ"].Value);
        ...
        public override void Write(BinaryWriter writer)
        {
            ...
            //if (this.Exists)
                writer.Write(this.Position.Global);
        }
