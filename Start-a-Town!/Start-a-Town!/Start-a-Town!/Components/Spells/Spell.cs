...
{
    class Spell : Component, ICloneable
    {
        ...
        public enum Types { Healing, Fireball }
        ...
        static void Initialize()
        {
            ...
            {
                new Spell().Initialize(Types.Healing, "Healing"),
                new Spell().Initialize(Types.Fireball, "Fireball")
            };
        }

        static Spell GetSpell(Types id)
        {
        ...
        static public Spell Create(Types id)
        {
        ...
        public Dictionary<Resource.Types, float> Cost { get; set; }
        ...
        public Spell Initialize(Types id, string name)
        {
            this.ID = id;
            this.Name = name;
            this.Cost = new Dictionary<Resource.Types, float>();
        ...
        public GameObject ToObject()
        {
            ...
            obj.AddComponent<GeneralComponent>().Initialize(GameObject.Types.Spell, "Spell", this.Name, this.Description);
