...
namespace Start_a_Town_.Components
{
    class WorkbenchReactionComponent : Component
    {
        ...
        public override object Clone()
        {
            ...
            return new WorkbenchReactionComponent();
        }
        ...
        private List<Reaction> GetAvailableBlueprints(GameObject parent)
        {
            return (from reaction in Reaction.Dictionary.Values
                    ...
                    where reaction.Sites.Contains(parent.GetInfo().ID)//(int)parent.ID)
        ...
        //private void RefreshSelectedPanel(Panel panel_Selected, Reaction reaction, List<GameObjectSlot> materials)// Reaction reaction)
        //{
        //    if (reaction.IsNull())
        //        return;
        //    RefreshSelectedPanel(panel_Selected, reaction.Products.First().Create(reaction, (from s in materials select s.Object).ToList()), (from s in materials select new ItemRequirement(s.Object.ID, 1)).ToList());
        //}
        ...
        class InteractionInsertMaterial : Interaction
        {
            ...
            public InteractionInsertMaterial(ItemContainer container)
                : base(
                "Insert Item",
                0,
                new TaskConditions(
