    ...
    class BuildingPlacer : ControlTool
    {
        ...
        public override ControlTool.Messages MouseLeftUp(System.Windows.Forms.HandledMouseEventArgs e)
        {
            ...
            if (this.Target.Type != TargetType.Position)
                return Messages.Default;
            Net.Client.PlayerBuild(this.Building, this.Target.Global + this.Target.Face);
        ...
        internal override void DrawBeforeWorld(MySpriteBatch sb, IMap map, Camera cam)
        {
            ...
            sprite.Draw(sb, pos, Color.White * 0.5f, 0, sprite.Origin, cam.Zoom, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, depth);
            sb.Flush();
        }
    }
}
