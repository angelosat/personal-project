...
namespace Start_a_Town_.GameModes.StaticMaps.UI
{
    class StaticWorldCreateWindow : Window
    {
        ...
        void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            world = new StaticWorld(new WorldArgs(Txt_MapName.Text, Chk_Trees.Checked, seed, mutators));

            //world.Save();
            Tag = world;

            ////var map =  Map.Create(world, Vector2.Zero);
            //var map = world.CreateMap(Vector2.Zero);
