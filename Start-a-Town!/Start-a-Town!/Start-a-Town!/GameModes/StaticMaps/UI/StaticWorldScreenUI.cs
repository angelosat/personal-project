...
namespace Start_a_Town_.GameModes.StaticMaps.UI
{
    class StaticWorldScreenUI : Start_a_Town_.UI.Control
    {
        ...
        StaticWorldScreenUI()
        {
            ...
            //WorldBrowser = new StaticWorldBrowser(200, WindowManager.LastScreenHeight - Panel_Info.Height - Panel_WorldButtons.Height, OnWorldCreated);// Load);
            ...
            this.Controls.Add(
                ...
                Panel_WorldButtons, 
                //platebox,  
                this.Panel_WorldList); //, Panel_MapInfo
            ...
            Panel_WorldList.Location = Panel_WorldButtons.Location;// BottomRight;
            Panel_WorldList.Anchor = Vector2.UnitY;
            this.WorldBrowser.Refresh();
            //Panel_WorldList.Toggle();
        }
        ...
        private void Load(IWorld world)
        {
            ...
            {
                //var dialog = new MessageBox("Please wait...", "Generating thumbnails");
                //dialog.Show();
        ...
        void EnterMap()
        {
            this.EnterMap(Panel_MapInfo.Tag as Map);
        }
