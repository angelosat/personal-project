...
namespace Start_a_Town_.Modules.Crafting.UI
{
    class CraftInterfaceNew : GroupBox
    {
            ...
            Action refreshBpList = () =>
            {
                list.Build(GetAvailableBlueprints(), foo => foo.Name, (r, btn) =>
                {
                    btn.LeftClickAction = () =>
                    {
                        ...
                        this.Panel_Reagents.Refresh(r, Player.Actor.GetComponent<PersonalInventoryComponent>().GetContents());
                    };
                });
            };
            refreshBpList();
        ...
        private void Build()
        {
            ...
            Net.Client.PlayerCraftRequest(new Components.Crafting.CraftOperation(this.SelectedReaction.ID, product.Requirements, Player.Actor, product.Tool, container));
        ...
        private void UpdateAvailableMaterials()
        {
            ...
            var container = Player.Actor.GetComponent<PersonalInventoryComponent>().Slots.Slots.Where(o => o.HasValue);
        ...
        protected virtual List<Reaction> GetAvailableBlueprints()
        {
            return (from reaction in Reaction.Dictionary.Values
                    ...
                    where reaction.ValidWorkshops.Contains(Tokens.IsWorkstation.Types.None)
        ...
        private void RefreshSelectedPanel(Reaction.Product.ProductMaterialPair product)
        {
            ...
            //var availableMats = nearbyMaterials.Concat(container);
            var availableMats = product.MaterialsFound(Player.Actor);
