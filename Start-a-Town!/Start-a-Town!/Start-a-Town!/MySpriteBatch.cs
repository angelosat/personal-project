...
namespace Start_a_Town_
{
    ...
    public class MySpriteBatch
    {
        ...
        public void Draw(Texture2D texture, Vector2 screenPos, Rectangle srcRectangle, float rotation, Vector2 origin, Vector2 scale, Color sky, Color block, Color color, Color fog, SpriteEffects sprFx, float depth)
        {
            ...
            vertices[vertexCount++] = new MyVertex(
                new Vector3(tl, depth)
                , fog, color, sky, block.ToVector4(), GetUV(srcRectangle.Left, srcRectangle.Top));
            vertices[vertexCount++] = new MyVertex(
                new Vector3(tr, depth)
                , fog, color, sky, block.ToVector4(), GetUV(srcRectangle.Right, srcRectangle.Top));
            vertices[vertexCount++] = new MyVertex(
                new Vector3(br, depth)
                , fog, color, sky, block.ToVector4(), GetUV(srcRectangle.Right, srcRectangle.Bottom));
            vertices[vertexCount++] = new MyVertex(
                new Vector3(bl, depth)
                , fog, color, sky, block.ToVector4(), GetUV(srcRectangle.Left, srcRectangle.Bottom));
        }
        ...
        public void Draw(Texture2D texture, Vector2 screenPos, Rectangle srcRectangle, float rotation, Vector2 origin, Vector2 scale, Color sky, Color block, Color material, Color tint, Color fog, SpriteEffects sprFx, float depth)
        {
            ...
            vertices[vertexCount++] = new MyVertex(
                new Vector3(tl, depth)
                , fog, tint, material, sky, block.ToVector4(), Vector4.Zero, GetUV(srcRectangle.Left, srcRectangle.Top));
            vertices[vertexCount++] = new MyVertex(
                new Vector3(tr, depth)
                , fog, tint, material, sky, block.ToVector4(), Vector4.Zero, GetUV(srcRectangle.Right, srcRectangle.Top));
            vertices[vertexCount++] = new MyVertex(
                new Vector3(br, depth)
                , fog, tint, material, sky, block.ToVector4(), Vector4.Zero, GetUV(srcRectangle.Right, srcRectangle.Bottom));
            vertices[vertexCount++] = new MyVertex(
                new Vector3(bl, depth)
                , fog, tint, material, sky, block.ToVector4(), Vector4.Zero, GetUV(srcRectangle.Left, srcRectangle.Bottom));
        }
        ...
        public MyVertex[] DrawBlock(Texture2D texture, Vector4 screenBounds, IAtlasNodeToken token, float scale, Color fog, Color tint, Color sunLight, Vector4 blockLight, float depth)
        {
            return this.DrawBlock(texture, screenBounds, token, scale, fog, tint, Color.White, sunLight, blockLight, Color.Transparent.ToVector4(), depth);
        }
        public MyVertex[] DrawBlock(Texture2D texture, Vector4 screenBounds, IAtlasNodeToken token, float scale, Color fog, Color tint, Color sunLight, Vector4 blockLight, float depth, Vector3 blockcoords)
        {
            return this.DrawBlock(texture, screenBounds, token, scale, fog, tint, Color.White, sunLight, blockLight, Color.Transparent.ToVector4(), depth, blockcoords);
        }
        public MyVertex[] DrawBlock(Texture2D texture, Vector4 screenBounds, IAtlasNodeToken token, float scale, Color fog, Color tint, Color material, Color sunLight, Vector4 blockLight, Vector4 water, float depth)
        {
            return this.DrawBlock(texture, screenBounds, token, scale, fog, tint, material.ToVector4(), sunLight, blockLight, water, depth, Vector3.Zero);
        }
        public MyVertex[] DrawBlock(Texture2D texture, Vector4 screenBounds, IAtlasNodeToken token, float scale, Color fog, Color tint, Color material, Color sunLight, Vector4 blockLight, Vector4 water, float depth, Vector3 blockcoords)
        {
            return this.DrawBlock(texture, screenBounds, token, scale, fog, tint, material.ToVector4(), sunLight, blockLight, water, depth, blockcoords);
        }
        public MyVertex[] DrawBlock(Texture2D texture, Vector4 screenBounds, IAtlasNodeToken token, float scale, Color fog, Color tint, Vector4 material, Color sunLight, Vector4 blockLight, Vector4 water, float depth, Vector3 blockCoords)
        {
            //Vector4 dstRectangle = new Vector4(screenPos.X, screenPos.Y, screenPos.X + scale * token.Rectangle.Width, screenPos.Y + scale * token.Rectangle.Height);
            //this.DrawBlock(texture, token, destRectangle, tint, sunLight, blockLight, depth);
            if (this.texture != null && this.texture != texture)
            ...
            var vertex1 = new MyVertex(
                new Vector3(screenBounds.X, screenBounds.Y, depth)
                , fog, tint, material, sunLight, blockLight, water, token.TopLeftUV, blockCoords);
            var vertex2 = new MyVertex(
                new Vector3(screenBounds.X + screenBounds.Z, screenBounds.Y, depth)
                , fog, tint, material, sunLight, blockLight, water, token.TopRightUV, blockCoords);
            var vertex3 = new MyVertex(
                new Vector3(screenBounds.X + screenBounds.Z, screenBounds.Y + screenBounds.W, depth)
                , fog, tint, material, sunLight, blockLight, water, token.BottomRightUV, blockCoords);
            var vertex4 = new MyVertex(
                new Vector3(screenBounds.X, screenBounds.Y + screenBounds.W, depth)
                , fog, tint, material, sunLight, blockLight, water, token.BottomLeftUV, blockCoords);
        ...
        public void DrawBlock(Texture2D texture, GameModes.IMap map, Vector3 global, IAtlasNodeToken token, Camera cam, Color fog, Color tint, Color sunLight, Vector4 blockLight)
        {
