...
namespace Start_a_Town_
{
    ...
    public class GameObjectSlot : ITooltippable
    {
        ...
        {
            get { return this.Container.IsNull() ? this._Parent : this.Container.Parent; }
            set
            {
                this._Parent = value;
                if (this.HasValue)
        ...
        public GameObject Take()
        {
            if (Object == null)
                return null;
            GameObject obj = StackSize == 1 ? this.Object : GameObject.Create(this.Object.ID);
            StackSize -= 1;
            if (StackSize == 0)
                Clear();
            return obj;
        ...
        public bool Take(out GameObject obj)
        {
            ...
            obj = StackSize == 1 ? this.Object : GameObject.Create(this.Object.ID);
            StackSize -= 1;
            if (StackSize == 0)
                Clear();
            return true;
        ...
        public List<SaveTag> Save()
        {
            ...
            data.Add(new SaveTag(SaveTag.Types.Compound, "Object", Object.Save()));
        ...
        public List<SaveTag> SaveShallow()
        {
            //            return Object.Save();
            List<SaveTag> data = new List<SaveTag>();//Tag(Tag.Types.Compound, "Slot");
            data.Add(new SaveTag(SaveTag.Types.Int, "Object", this.HasValue ? (int)Object.ID : -1));
            data.Add(new SaveTag(SaveTag.Types.Byte, "Stack", (byte)StackSize));
            return data;
        }
        ...
        public bool Insert(GameObjectSlot toInsert)
        {
            ...
            if(this.Object.ID != toInsert.Object.ID)
                return false;
        ...
        public void Dispose()
        {
            if (this.Object == null)
                return;
            if (this.Object.Net == null && this.Object.Network.ID != 0)
                throw new Exception();
