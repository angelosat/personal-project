...
namespace Start_a_Town_
{
    ...
    public class Map : Component, IMap, IObjectSpace, IDisposable, ITooltippable
    {
       ...
       // public DirectoryInfo DirectoryInfo { get { return (DirectoryInfo)this["DirectoryInfo"]; } set { this["DirectoryInfo"] = value; } }
        ...
        //    {
        //        camera.Location = new Vector2( -Chunk.Width / 2, 0);
        //    }
        //    if (camera.Rotation == 1)
        //    {
        //        camera.Location = new Vector2(Chunk.Width + Tile.Width / 2, -Chunk.Width / 4);
        //    }
        //    if (camera.Rotation == 2)
        //    {
        //        camera.Location = new Vector2(-Chunk.Width / 2, -Chunk.Width / 2);
        //    }
        //    if (camera.Rotation == 3)
        //    {
        //        camera.Location = new Vector2(-Tile.Width / 2, -Chunk.Width / 4);
        //    }
        ...
        //    //camera.X = oldx;
        //    //camera.Y = oldy;
        //    camera.Location = new Vector2(oldx, oldy);
        //    camera.Zoom = oldZoom;
       ...
       // public SortedList<float, Position> Mouseover = new SortedList<float, Position>();
        ...
        {
            return (global.GetChunk(this).TryGetBlockObject(global.ToLocal().RoundXY(), out blockObj));
