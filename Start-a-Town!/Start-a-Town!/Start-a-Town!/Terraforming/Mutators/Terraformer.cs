...
namespace Start_a_Town_
{
    public abstract class Terraformer : IComparable<Terraformer>, ICloneable//, 
    {
        ...
        public static readonly Terraformer Trees = new Trees();
        ...
        static Dictionary<Types, Terraformer> _Dictionary = new Dictionary<Types, Terraformer>()
        {
            {Types.Land, Land},
            {Types.Sea, Sea},
            {Types.Normal, Normal},
            ...
            for (int y = 0; y < size; y++)
                for (int x = 0; x < size; x++)
                {
                    for (int z = Map.MaxHeight - 1; z >= 0; z--)
                    {
                        ...
                        //cell.Type = this.Initialize(world, cell, x, y, z, Net.Server.Random);
                        cell.SetBlockType(this.Initialize(world, cell, x, y, z, Net.Server.Random));
