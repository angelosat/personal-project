...
namespace Start_a_Town_.UI
{
    ...
    public class BackgroundStyle
    {
        ...
        public void Draw(SpriteBatch sb, Rectangle bounds, Color color)
        {
            sb.Draw(SpriteSheet, new Vector2(bounds.X, bounds.Y), TopLeft, color, 0, new Vector2(0, 0), 1, SpriteEffects.None, 0);//.01f);
            sb.Draw(SpriteSheet, new Vector2(bounds.X + bounds.Width - TopRight.Width, bounds.Y), TopRight, color, 0, new Vector2(0, 0), 1, SpriteEffects.None, 0);// 0.01f);
            sb.Draw(SpriteSheet, new Vector2(bounds.X, bounds.Y + bounds.Height - BottomLeft.Height), BottomLeft, color, 0, new Vector2(0, 0), 1, SpriteEffects.None, 0);// 0.01f);
            sb.Draw(SpriteSheet, new Vector2(bounds.X + bounds.Width - BottomRight.Height, bounds.Y + bounds.Height - BottomLeft.Height), BottomRight, color, 0, new Vector2(0, 0), 1, SpriteEffects.None, 0);// 0.01f);

            //top, left, right, bottom
            sb.Draw(SpriteSheet, new Rectangle(bounds.X + Left.Width, bounds.Y, bounds.Width - Left.Width - Right.Width, Top.Height), Top, color, 0, new Vector2(0, 0), SpriteEffects.None, 0);// 0.01f);
            sb.Draw(SpriteSheet, new Rectangle(bounds.X, bounds.Y + Top.Height, Left.Width, bounds.Height - Top.Height - Bottom.Height), Left, color, 0, new Vector2(0, 0), SpriteEffects.None, 0);// 0.01f);
            sb.Draw(SpriteSheet, new Rectangle(bounds.X + bounds.Width - Right.Width, bounds.Y + Top.Height, Right.Width, bounds.Height - Top.Height - Bottom.Height), Right, color, 0, new Vector2(0, 0), SpriteEffects.None, 0);// 0.01f);
            sb.Draw(SpriteSheet, new Rectangle(bounds.X + Left.Width, bounds.Y + bounds.Height - Bottom.Height, bounds.Width - Left.Width - Right.Width, Bottom.Height), Bottom, color, 0, new Vector2(0, 0), SpriteEffects.None, 0);// 0.01f);

            //center
            sb.Draw(SpriteSheet, new Rectangle(bounds.X + Left.Width, bounds.Y + Top.Height, bounds.Width - Left.Width - Right.Width, bounds.Height - Top.Height - Bottom.Height), Center, color, 0, new Vector2(0, 0), SpriteEffects.None, 0);// 0.01f);
        }
        ...
        public void Draw(SpriteBatch sb, Rectangle bounds, Color tint, float opacity = 1)
        {
