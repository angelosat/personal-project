...
namespace Start_a_Town_.UI
{
    class Picker : GroupBox
    {
        ...
        public Picker()//Action<Color> callback)
        {
            ...
            this.LightnessPick = new LightnessPicker() { Location = this.ColorPick.TopRight };
    ...
    class LightnessPicker : PictureBox
    {
        ...
        static Texture2D CreateGradient()
        {
            for (int v = 0; v < 256; v++)
                for (int x = 0; x < TexWidth; x++)
                {
                    ...
                    Color color = ColorPicker.HSVtoRGB(0, 0, val);
        ...
        public void SelectColor(Color rgb)
        {
            float h, s, v;
            h = s = v = 0;
            ColorPicker.RGBtoHSV(rgb, ref h, ref s, ref v);
