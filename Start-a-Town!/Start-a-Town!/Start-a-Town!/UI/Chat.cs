...
namespace Start_a_Town_.UI
{
    class Chat : Window
    {
        ...
        public Chat()
        {
            ...
            Chatbox = new PictureBox(Vector2.Zero, Texture, panel.ClientSize, HorizontalAlignment.Left, VerticalAlignment.Top);
        ...
        void TextBox_KeyPress(object sender, KeyPressEventArgs2 e)
        {
            switch (e.Key)
            {
                case Keys.Enter:
