...
{
    class Construction2Window : Window
    {
        static Construction2Window _Instance;
        public static Construction2Window Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new Construction2Window();
                return _Instance;
            }
        }
        ...
        ConstructionOldComponent ConstructionComponent;
        int k;
        public Construction2Window(GameObject construction = null, GameObject material = null)
        {
            Title = "Construction";
            ...
            if (construction == null)
                throw (new ArgumentNullException("construction", "construction not set for Construction Window"));
            ConstructionComponent = (ConstructionOldComponent)construction["Construction"];
      ...
      //      {
        ...
        void listEntry_Click(object sender, EventArgs e)
        {
            ...
            ConstructionComponent.SetBlueprint(SelectedItem);
            Hide();
        }
    }
}
