...
namespace Start_a_Town_
{
    public class ContextAction
    {
        ...
        public ContextAction(Components.Interactions.Interaction interaction)
        {
            this.Name = () => interaction.Name;
        }
        public ContextAction(Components.Interactions.Interaction interaction, GameObject player, TargetArgs target)
        {
            this.Name = () => interaction.Name;
