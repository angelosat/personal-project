...
namespace Start_a_Town_.UI
{
    class CraftingWindow : Window
    {
        ...
        public CraftingWindow()
        {
            ...
            //Blueprints = CraftingManager.Instance.GetBlueprints();
            Blueprints = WorkbenchComponent.Blueprints.Values.ToList();
            ...
            //Panel_Styles = new Panel(new Vector2(List.Right, List.Controls[(int)List.SelectedValue].Location.Y));
            ...
            //Panel_Info.Controls.Add(new Label(""));
