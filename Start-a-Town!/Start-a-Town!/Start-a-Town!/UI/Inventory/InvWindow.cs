        ...
        public InvWindow Initialize(GameObject obj)
        {
            ...
            this.DropSlot = new Slot(this.Client.Controls.BottomLeft)
            {
                DragDropAction = args =>
                {
                    ...
                    //Net.Client.PlayerDropInventory(a.Source.ID, a.Source.StackSize);
                    ...
                    //Net.Client.PlayerDropInventory(childIndex, a.Source.StackSize);
                    var childIndex = Player.Actor.GetChildren().IndexOf(a.SourceTarget.Slot);//.First(slot => slot == a.Source).ID;
                    if (childIndex == -1)
                ...
                Panel_Slots.Controls.Add(new InventorySlot(invSlot, Actor, i)
                {
                    ...
                    DragDropAction = args =>
                    {
                        ...
                        if (a.Effects == DragDropEffects.None)
                            return DragDropEffects.None;
                        //Net.Client.PlayerInventoryOperation(Player.Actor, a.Source, invSlot, a.Slot.StackSize);
                        ...
                        //Net.Client.PlayerInventoryOperationOld(Player.Actor, w =>
                        //{
                        ...
                        //Net.Client.PostPlayerInput(Message.Types.ArrangeChildren, w =>
                        //{
                        //    ArrangeChildrenArgs.Write(w, new TargetArgs(a.Parent), new TargetArgs(a.Source.Object), new TargetArgs(a.Slot.Object), a.Source.ID, invSlot.ID, (byte)a.Slot.StackSize);
                        //});
                        //return DragDropEffects.Move;
