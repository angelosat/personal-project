...
namespace Start_a_Town_.UI
{
    ...
    {
        Panel Panel_Buttons, Panel_WorldInfo, Panel_Thumbnail;
        PanelList<DirectoryInfo> Panel_Main;
        Button Btn_Create, Btn_Start, Btn_Delete, Btn_Folder;
        ...
        public SelectMapWindow()
        {
            ...
            Panel_Main = new PanelList<DirectoryInfo>(Vector2.Zero, new Vector2(200, 300), foo => foo.Name);
            Panel_Main.SelectedItemChanged += new EventHandler<EventArgs>(Panel_Main_SelectedItemChanged);
            ...
            Btn_Folder = new Button(new Vector2(0, Btn_Create.Bottom), Btn_Create.Width, "Open Worlds Folder");
            RefreshWorldList();


            Panel_Buttons.Controls.Add(Btn_Create, Btn_Folder);//, Btn_Start);
            ...
            Btn_Folder.Click += new UIEvent(Btn_Folder_Click);
        }

        void Btn_Folder_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start(GlobalVars.SaveDir + "/Worlds/");
        }

        void Panel_Main_SelectedItemChanged(object sender, EventArgs e)
        {
            DirectoryInfo worldDirectory = Panel_Main.SelectedItem;
        ...
        private void RefreshWorldInfo(DirectoryInfo worldDirectory = null)
        {
            ...
            //    return;
            //}
            FileInfo[] worldFiles = worldDirectory.GetFiles("*.map.sat", SearchOption.TopDirectoryOnly);
        ...
        {
            NewMapWindow win = new NewMapWindow();
            win.ShowDialog();
            win.Hidden += new EventHandler<EventArgs>(createWorld_Closed);
        }

        void createWorld_Closed(object sender, EventArgs e)
        {
            //Console.WriteLine((sender as SelectCharacterWindow).Tag as GameObject);
            Console.WriteLine((sender as NewMapWindow).Tag as GameObject);
            RefreshWorldList();
        }
