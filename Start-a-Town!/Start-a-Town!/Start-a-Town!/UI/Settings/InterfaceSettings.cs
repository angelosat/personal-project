...
namespace Start_a_Town_.UI.Settings
{
    ...
    {
        bool Changed;
        Slider Sldr_UIScale, Sldr_TooltipDelay;
        CheckBox 
         Chkbox_MouseTooltip;
        Label Lbl_UIScale, Lbl_Delay;
        ...
        public InterfaceSettings()
        {
            ...
            this.Sldr_TooltipDelay = new Slider(lbl_delay.BottomLeft, 100, 0, 2, 0.1f, TooltipManager.DelayInterval / Engine.TargetFps) { Name = "Tooltip Delay: {0}s" };
