...
namespace Start_a_Town_.UI
{
    class SettingsWindow : Window
    {
        ...
        CheckBox check_fullscreen, 
            ...
            CB_AsyncLoading,
            CB_MouseTooltip, Chk_HideWalls, Chk_HideTerrain;
        ...
        SettingsWindow()
        {
            ...
            Sldr_TooltipDelay = new Slider(lbl_delay.BottomLeft, Combo_Resolutions.Width, 0, 2, 0.1f, TooltipManager.DelayInterval / Engine.TargetFps) { Name = "Tooltip Delay: {0}s" };
