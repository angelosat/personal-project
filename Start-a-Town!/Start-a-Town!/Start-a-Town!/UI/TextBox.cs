...
namespace Start_a_Town_.UI
{
    ...
    public class TextBox : Label //Control
    {
       ...
       // public TextBox(Vector2 position, Vector2 size) : base(position, size) { this.Initialize(); }
        ...
        //static public new int Height = UIManager.ProgressBarBorder.Height;
        //static public new int Width = UIManager.ProgressBarBorder.Width;
       ...
       // override handle
        ...
        //    {
        //        Vector2 textbounds = UIManager.Font.MeasureString(Text);
        //        sb.Draw(UIManager.Highlight, new Rectangle((int)(ScreenLocation.X + textbounds.X), (int)(ScreenLocation.Y), 3, Height), Color.White);
        //    }
        //    base.Draw(sb);
        //}
        ...
        {
            //Controller.TextInput.KeyPress -= TextInput_KeyPress;
            //Controller.TextInput.KeyDown -= TextInput_KeyDown;
            Texture.Dispose();
            CursorTimer.Stop();
        }
