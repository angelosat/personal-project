...
{
    class SmeltingWindow : Window
    {
        static SmeltingWindow _Instance;
        public static SmeltingWindow Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new SmeltingWindow();
                return _Instance;
            }
        }
        ...
        SmeltingWindow()
        {
            this.AutoSize = true;
            this.Title = "Smelting";
            this.Client.Controls.Add(SmeltingInterface.Instance);
    ...
    class SmeltingInterface : GroupBox
    {
        static SmeltingInterface _Instance;
        public static SmeltingInterface Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new SmeltingInterface();
                return _Instance;
            }
        }
